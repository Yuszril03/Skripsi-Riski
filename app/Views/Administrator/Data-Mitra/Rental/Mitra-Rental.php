            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="float-right">
                        <button onclick="location.href='<?= base_url() ?>/Tambah-Mitra-Rental'" class="btn btn-success" style="border-radius: 15px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button onclick="location.href='<?= base_url() ?>/Edit-Mitra-Rental'" class="btn btn-warning btn-sm" title="Edit Data"><i class="fa fa-pen-alt"></i></button>
