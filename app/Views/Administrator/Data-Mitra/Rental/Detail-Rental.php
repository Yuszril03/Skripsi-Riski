...
<head>
    ...
    <title>TraveLand - Detail Mitra Rental</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">
                                <button class="btn" onclick="location.href=`<?= base_url() ?>/Mitra-Rental`" title="Kembali"><i class="fa fa-angle-left fa-2x"></i></button>
                                Detail Rental
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Detail Rental</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card card-outline card-warning" style="border-radius: 15px;">
                        <div class="card-body">
                            <img id="fotoRentall" src="https://firebasestorage.googleapis.com/v0/b/traveland-429a6.appspot.com/o/images-customer%2Fno-image.png?alt=media&token=87603e1a-2c32-488c-81a6-ad35ce8619a4" width="300" alt="">
                            <h4 class="mt-2 font-weight-bold" id="namaWisataa">Nama Rental</h4>
                            ...
                            <div style="background-color: #f7f7f7;" class="p-1 mb-2 rounded">
                                <i class="bi bi-card-text text-primary"></i> Data Detail Rental
                            </div>
    ...
    <script type="module">
        ...
        const ValueItemWisata = ref(db, 'Master-Data-Rental/<?= $DataIDRental ?>');
        onValue(ValueItemWisata, (kontenn) => {
            ...
            document.getElementById('namaWisataa').innerHTML = kontenn.val().NamaRental
            document.getElementById('alamatWisata').innerHTML = kontenn.val().AlamatRental
            document.getElementById('deskripsiWisata').innerHTML = kontenn.val().DeskripsiRental
            ...
            if (kontenn.val().fotoRental != "") {
                document.getElementById('fotoRentall').src = kontenn.val().fotoRental
            }
        });

        const ValueItemRentalDetail = ref(db, 'Master-Data-Rental-Detail/');
        onValue(ValueItemRentalDetail, (kontenn) => {
            const keys = Object.keys(kontenn.val());
            for (const isi in keys) {
                const ValueItemRental = ref(db, 'Master-Data-Rental-Detail/' + keys[isi]);
                onValue(ValueItemRental, (kontenn22) => {

                    if (`<?= $DataIDRental ?>` == kontenn22.val().IdRental) {
                        const options = {
                            weekday: 'long',
                            year: 'numeric',
                            month: 'long',
                        ...
                        if (kontenn22.val().fotoKendaraan != "") {
                            fotoKendaraan = kontenn22.val().fotoKendaraan
                        }
                        let Status = "";
                        ...
                        table.row.add([
                            ` <tr>
                                            <td>
                                                ...
                                                <b>Deskripsi</b>
                                                <br>
                                                ${kontenn22.val().deskripsiKendaraan}
                                                </p>
                                            </td>
                                        </tr>`
                        ]).draw(false)
