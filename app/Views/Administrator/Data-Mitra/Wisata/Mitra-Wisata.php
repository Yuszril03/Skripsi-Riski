                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Text</td>
                                            <td>
                                                <button class="btn btn-info btn-sm" title="Detail Data"><i class="fa fa-info-circle"></i></button>
                                                <button class="btn btn-warning btn-sm" title="Edit Data"><i class="fa fa-pen-alt"></i></button>
