...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Data Version Android</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Edit Data Version Android</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nomorVersi" disabled class="form-control" style="border-radius: 15px;" placeholder="Ketik di sini...">
                                        </div>
                                        <div class="form-group">
    ...
    <script type="module">
        ...
        const ValueItem = ref(db, 'Data-Version/<?= $DataID ?>');
        onValue(ValueItem, (kontenn) => {
            let PostD = {

                NomorVersi: kontenn.val().nomorVersi,
                Deskripsi: kontenn.val().Deskripsi,
                LinkUpdate: kontenn.val().LinkUpdate,
                TanggalBuat: kontenn.val().TanggalBuat,

            };
            parseJsonAdminVersion = (PostD)
            if (Boolean(parseJsonAdminVersion) == false) {
                ...
                document.getElementById('nomorVersi').value = kontenn.val().nomorVersi
                document.getElementById('deskripsi').value = kontenn.val().Deskripsi
                document.getElementById('linkUpdate').value = kontenn.val().LinkUpdate
                ...
                if (result.isConfirmed) {
                    ...
                    if (jumlah == 0) {
                        let PostD = {
                            ...
                            TanggalBuat: parseJsonAdminVersion.TanggalBuat,

                        };
                        const updates = {};
                        updates['/Data-Version/<?= $DataID ?>'] = PostD;
