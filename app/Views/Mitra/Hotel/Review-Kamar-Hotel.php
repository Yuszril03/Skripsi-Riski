                            ...
                            onValue(database5, (snapshot5) => {
                                ...
                                if (snapshot2.val().IdMitra == "<?= session()->get('IDKelola') ?>") {
                                    let PostData = {
                                        ...
                                        HargaKamar: snapshot2.val().HargaKamar,
                                        IdCutomer: snapshot2.val().IdCutomer,
                                        IdKamar: snapshot2.val().IdKamar,
                    ...
                    `
                                    ...
                                    if (Number(snapshot2.val().StatusTransaksi) == 1) {
                                        ...
                                        table.row.add([
                                            ...
                                            keysTransaksi[isi],
                                            `<input type ="hidden" name ="NamaHotelT[]" value ="${snapshot4.val().NamaHotel}" > ` +
                                            snapshot4.val().NamaHotel,
                                            `<input type ="hidden" name ="NamaHotelT[]" value ="${snapshot5.val().NamaKamar}" > ` +
        ...
        document.getElementById('submit').addEventListener('click', function() {
            ...
            if (angka == 0) {
                ...
                let PostD = {
                    ...
                    HargaKamar: parseJsonTransaksi[ss].HargaKamar,
                    IdCutomer: parseJsonTransaksi[ss].IdCutomer,
                    IdKamar: parseJsonTransaksi[ss].IdKamar,
                    ...
                    JumlahKamar: parseJsonTransaksi[ss].JumlahKamar,
                ...
                const updates = {};
                updates['Transaction-Hotel/' + idDataa] = PostD;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        location.href = "<?= base_url() ?>/Review-Kamar-Hotel"
                    }
                })
            } else {
                Swal.fire({
