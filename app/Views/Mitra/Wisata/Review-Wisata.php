                        ...
                        onValue(database4, (snapshot4) => {
                            if (snapshot2.val().IdMitra == "<?= session()->get('IDKelola') ?>") {
                                let PostData = {
                                    ...
                                    HargaAnak: snapshot2.val().HargaAnak,
                                    HargaDewasa: snapshot2.val().HargaDewasa,
                                    ...
                                    TotalAnak: snapshot2.val().TotalAnak,
                                    TotalDewasa: snapshot2.val().TotalDewasa,
                    ...
                    `
                                ...
                                if (Number(snapshot2.val().StatusTransaksi) == 1) {
                                    ...
                                    table.row.add([
                                        ...
                                        keysTransaksi[isi],
                                        `<input type ="hidden" name ="NamaWisataT[]" value ="${snapshot4.val().NamaWisata}" > ` +
        ...
        document.getElementById('submit').addEventListener('click', function() {
            ...
            if (angka == 0) {
                ...
                let PostD = {
                    ...
                    HargaAnak: parseJsonTransaksi[ss].HargaAnak,
                    HargaDewasa: parseJsonTransaksi[ss].HargaDewasa,
                    ...
                    JumlahAnak: parseJsonTransaksi[ss].JumlahAnak,
                    JumlahDewasa: parseJsonTransaksi[ss].JumlahDewasa,
                    Rating: parseJsonTransaksi[ss].Rating,
                    StatusTransaksi: parseJsonTransaksi[ss].StatusTransaksi,
                    TotalAnak: parseJsonTransaksi[ss].TotalAnak,
                    TotalDewasa: parseJsonTransaksi[ss].TotalDewasa,
                ...
                const updates = {};
                updates['Transaction-Wisata/' + idDataa] = PostD;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        location.href = "<?= base_url() ?>/Review-Wisata"
                    }
                })
            } else {
                Swal.fire({
