...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script type="module">
        ...
        const ValueItem11 = ref(db, 'Transaction-Rental/<?= $DataID ?>');
        onValue(ValueItem11, (kontenns) => {
            let PostD = {
                ...
                HargaMobil: kontenns.val().HargaMobil,
                IdCutomer: kontenns.val().IdCutomer,
                IdMobil: kontenns.val().IdMobil,
                ...
                UkuranMobil: kontenns.val().UkuranMobil
        ...
        document.getElementById('submitData').addEventListener('click', function() {
            ...
            if (angka == 0) {
                ...
                const updates = {};
                updates['Transaction-Rental/<?= $DataID ?>'] = PostD;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        location.href = "<?= base_url() ?>/Detail-Pemesanan-Kendaraan"
                    }
                })
            } else {
                Swal.fire({
